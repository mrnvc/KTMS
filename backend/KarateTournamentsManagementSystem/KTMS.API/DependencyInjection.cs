...
public static class DependencyInjection
{
        ...
        IHostEnvironment env)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "KTMS API", Version = "v1" });
            var xml = Path.Combine(AppContext.BaseDirectory, "KTMS.API.xml");
            if (File.Exists(xml))
        ...
        //services.AddExceptionHandler<KTMSExceptionHandler>();
