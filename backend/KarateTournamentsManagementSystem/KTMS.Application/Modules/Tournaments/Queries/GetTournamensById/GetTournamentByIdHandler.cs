...
namespace KTMS.Application.Modules.Tournaments.Queries.GetTournamensById
{
    public class GetTournamentByIdHandler : IRequestHandler<GetTournamentsByIdQuery, TournamentDto>
    {
        private readonly IAppDbContext _dbContext;
        public GetTournamentByIdHandler(IAppDbContext dbContext) 
        {
            _dbContext = dbContext;
        }
        public async Task<TournamentDto>Handle(GetTournamentsByIdQuery request, CancellationToken cancellationToken) 
        {
