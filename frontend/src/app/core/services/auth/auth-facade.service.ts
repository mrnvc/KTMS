...
export class AuthFacadeService {
  ...
  isCoach = computed(() => this._currentUser()?.isCoach ?? false);
  isContestant = computed(() => this._currentUser()?.isContestant ?? false);
  ...
  private decodeAndSetUser(token: string): void {
    try {
      ...
      const user: CurrentUserDto = {
        ...
        isCoach: payload.is_coach === 'true',
        isContestant: payload.is_contestant === 'true',
